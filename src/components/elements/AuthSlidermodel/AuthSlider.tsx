...
export default function AuthSlider({ isSignIn }: any) {
...
export function LeftOverlayPanel({ setSignIn }: any) {
  return (
    <div className="flex h-full flex-col items-center justify-center px-10 text-center">
      ...
      <p className="mb-5">
        Enter your credentials to access your account and continue where you
        left off. We’ve made it easier for you to stay connected!
      </p>
...
export function RightOverlayPanel({ setSignIn }: any) {
  return (
    <div className="flex h-full flex-col items-center justify-center px-10 text-center">
      ...
      <p className="mb-5">
        Sign up to access a world of possibilities. Enjoy personalized services,
        exclusive offers, and a community of like-minded individuals.
      </p>
